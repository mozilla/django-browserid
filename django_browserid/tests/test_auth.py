...
class BrowserIDBackendTests(TestCase):
    ...
    def test_duplicate_emails(self):
        ...
        new_user('a@test.com', 'test1')
        new_user('a@test.com', 'test2')
        assert self.auth('a@test.com') is None
    ...
    def test_auth_success(self):
        ...
        their user object.
        """
        user = new_user('a@test.com')
        assert self.auth('a@test.com') == user
    ...
    def test_custom_create_user(self, create_user):
        ...
        assert self.auth('a@test.com') == 'test'
        assert create_user.called_with('a@test.com')
